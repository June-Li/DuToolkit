...
import os
from MODELALG.RES.MPRNet.MPRNetv0.config import Config

opt = Config(cur_dir + "/config/train.yml")
...
from MODELALG.RES.MPRNet.MPRNetv0.data_RGB import get_training_data, get_validation_data
from MODELALG.RES.MPRNet.MPRNetv0.MPRNet import MPRNet
from MODELALG.RES.MPRNet.MPRNetv0 import losses
from MODELALG.RES.MPRNet.MPRNetv0.warmup_scheduler import GradualWarmupScheduler
...
optimizer = optim.Adam(
    model_restoration.parameters(), lr=new_lr, betas=(0.9, 0.999), eps=1e-8
)
