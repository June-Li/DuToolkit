...
from MODELALG.DET.YOLO.SSLYOLOv5.utils.datasets import (
    LoadStreams,
    LoadImages,
    letterbox,
)
...
from MODELALG.DET.YOLO.SSLYOLOv5.utils.plots import plot_one_box
    ...
    def __init__(
        ...
        with torch.no_grad():
            ...
            if os.path.exists(self.weights):
                ...
                self.model = attempt_load(
                    standby_weights, map_location=self.device
                )  # load FP32 model
                print("load model " + standby_weights + "......")
