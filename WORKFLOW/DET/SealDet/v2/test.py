...
from MODELALG.DET.YOLO.SSLYOLOv5.utils.metrics import ap_per_class, ConfusionMatrix
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=os.path.abspath(
            root_dir + "/MODEL/DET/YOLO/SSLYOLOv5/SealDet/20210720/best.pt"
        ),
    ...
    parser.add_argument(
        "--project", default=cur_dir + "/test_out/", help="save to project/name"
    )
