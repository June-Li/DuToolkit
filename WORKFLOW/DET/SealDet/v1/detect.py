...
from MODELALG.DET.YOLO.YOLOv5.utils.datasets import LoadStreams, LoadImages
...
from MODELALG.DET.YOLO.YOLOv5.utils.plots import colors, plot_one_box
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=root_dir
        + "/MODEL/DET/YOLO/YOLOv5/TableDet/20210605/runs/train/exp/weights/best.pt",
    ...
    parser.add_argument(
        "--source",
        type=str,
        default=cur_dir + "/test_data/my_imgs_0/TableBank_Latex_1505.07674_6.jpg",
        help="source",
    ...
    parser.add_argument(
        "--iou-thres", type=float, default=0.25, help="IOU threshold for NMS"
    )
    parser.add_argument(
        "--max-det",
        type=int,
