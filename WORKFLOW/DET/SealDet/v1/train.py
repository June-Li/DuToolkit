...
from WORKFLOW.DET.SealDet.v1 import test  # import test.py to get mAP after each epoch
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data",
        type=str,
        default=cur_dir + "/config/ocr_seal.yaml",
        help="data.yaml path",
    )
    parser.add_argument(
        "--hyp",
    ...
    parser.add_argument(
        "--batch-size", type=int, default=4, help="total batch size for all GPUs"
    )
    parser.add_argument(
        "--img-size",
        nargs="+",
    ...
    parser.add_argument(
        "--project",
        default=root_dir + "/MODEL/DET/YOLO/YOLOv5/SealDet/20210720/runs/train/",
