...
from utils.datasets_unlabel import create_dataloader
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data", type=str, default="data/ocr_table_unlabel.yaml", help="data.yaml path"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--device", default="2", help="cuda device, i.e. 0 or 0,1,2,3 or cpu"
    )
    parser.add_argument(
