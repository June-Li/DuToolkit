...
from utils.datasets_small import create_dataloader
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data", type=str, default="data/ocr_table_small.yaml", help="data.yaml path"
    )
    parser.add_argument(
    ...
    parser.add_argument("--project", default="runs/small", help="save to project/name")
