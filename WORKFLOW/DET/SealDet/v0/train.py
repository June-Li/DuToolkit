...
from detector_table import Detector
from detector_table import get_param
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--weights",
        type=str,
        default="./weights/yolov3.pt",
        help="initial weights path",
    )
    parser.add_argument(
        "--cfg", type=str, default="yolov3.yaml", help="model.yaml path"
    )
    parser.add_argument(
        "--data", type=str, default="data/ocr_table.yaml", help="data.yaml path"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--workers", type=int, default=2, help="maximum number of dataloader workers"
    )
