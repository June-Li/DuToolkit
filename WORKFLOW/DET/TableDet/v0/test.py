...
from MODELALG.DET.YOLO.YOLOv3.utils.datasets import create_dataloader
...
from MODELALG.DET.YOLO.YOLOv3.utils.loss import compute_loss
from MODELALG.DET.YOLO.YOLOv3.utils.metrics import ap_per_class, ConfusionMatrix
from MODELALG.DET.YOLO.YOLOv3.utils.plots import (
    plot_images,
    output_to_target,
    plot_study_txt,
)
from MODELALG.DET.YOLO.YOLOv3.utils.torch_utils import select_device, time_synchronized
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=os.path.abspath(
            root_dir + "/MODEL/DET/YOLO/YOLOv3/TableDet/20210531/best.pt"
        ),
    ...
    parser.add_argument(
        "--project",
        default=cur_dir + "/test_out/test_web_download_pad/",
