...
if __name__ == "__main__":
    ...
    )  # root_dir + '/MODEL/DET/YOLO/YOLOv5/TableDet/20210605//best.pt'
    parser.add_argument(
        "--cfg",
        type=str,
    ...
    parser.add_argument(
        "--data",
        type=str,
        default=cur_dir + "/config/ocr_table.yaml",
        help="data.yaml path",
    )
    parser.add_argument(
        "--hyp",
    ...
    parser.add_argument(
        "--project",
        default=root_dir + "/MODEL/DET/YOLO/YOLOv5/TableDet/20220505/runs/train/",
