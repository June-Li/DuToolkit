...
from WORKFLOW.DET.TableDet.v1 import test  # import test.py to get mAP after each epoch
from MODELALG.DET.YOLO.YOLOv5.models.experimental import attempt_load
from MODELALG.DET.YOLO.YOLOv5.models.yolo import Model
from MODELALG.DET.YOLO.YOLOv5.utils.autoanchor import check_anchors
from MODELALG.DET.YOLO.YOLOv5.utils.datasets import create_dataloader
...
from MODELALG.DET.YOLO.YOLOv5.utils.google_utils import attempt_download
from MODELALG.DET.YOLO.YOLOv5.utils.loss import ComputeLoss
from MODELALG.DET.YOLO.YOLOv5.utils.plots import (
    plot_images,
    plot_labels,
    plot_results,
    plot_evolution,
)
from MODELALG.DET.YOLO.YOLOv5.utils.torch_utils import (
    ModelEMA,
    select_device,
    intersect_dicts,
...
from MODELALG.DET.YOLO.YOLOv5.utils.wandb_logging.wandb_utils import (
    WandbLogger,
    check_wandb_resume,
)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=root_dir
        + "/MODEL/DET/YOLO/YOLOv5/TableCellDet/20210617/runs/train/exp5/weights/best.pt",
        help="initial weights path",
    )
    parser.add_argument(
        "--cfg",
        type=str,
        default=root_dir + "/MODELALG/DET/YOLO/YOLOv5/models/hub/yolov5l6.yaml",
        help="model.yaml path",
    )
    parser.add_argument(
        "--data",
        type=str,
        default=cur_dir + "/config/ocr_table_cell.yaml",
        help="data.yaml path",
    )
    parser.add_argument(
        "--hyp",
    ...
    parser.add_argument(
        "--batch-size", type=int, default=12, help="total batch size for all GPUs"
    )
    parser.add_argument(
        "--img-size",
        nargs="+",
    ...
    parser.add_argument(
        "--device", default="1,2,3", help="cuda device, i.e. 0 or 0,1,2,3 or cpu"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--workers", type=int, default=16, help="maximum number of dataloader workers"
    )
    parser.add_argument(
        "--project",
        default=root_dir + "/MODEL/DET/YOLO/YOLOv5/TableCellDet/20210617/runs/train/",
