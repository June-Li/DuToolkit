...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data",
        type=str,
        default=cur_dir + "/config/ocr_table_cell_content.yaml",
        help="data.yaml path",
    )
    parser.add_argument(
        "--hyp",
    ...
    parser.add_argument(
        "--batch-size", type=int, default=9, help="total batch size for all GPUs"
    )
    parser.add_argument(
        "--img-size",
        nargs="+",
    ...
    parser.add_argument(
        "--single-cls", default=True, help="train multi-class data as single-class"
    )
    ...
    parser.add_argument(
        "--project",
        default=root_dir
        + "/MODEL/DET/YOLO/YOLOv5/TableCellContentDet/20220422/runs/train/",
