...
from MODELALG.DET.YOLO.YOLOv5.utils.metrics import ap_per_class, ConfusionMatrix
from MODELALG.DET.YOLO.YOLOv5.utils.plots import (
    plot_images,
    output_to_target,
    plot_study_txt,
)
from MODELALG.DET.YOLO.YOLOv5.utils.torch_utils import select_device, time_synchronized
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs="+",
        type=str,
        default="/volume/weights/Detector_table_cell_content_model.pt",
    ...
    parser.add_argument(
        "--task", default="test", help="train, val, test, speed or study"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--project", default=cur_dir + "/test_out/runs/", help="save to project/name"
    )
