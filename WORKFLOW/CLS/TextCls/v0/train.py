...
from WORKFLOW.CLS.TextCls.v0.config import settings
...
from MODELALG.CLS.ClsCollect.ClsCollectv0.make_dataloader import get_dataloader
...
if __name__ == "__main__":
    ...
    angle_training_loader = get_dataloader(
        root_dir + "/DATASETS/CLS/TextCls/v0/train/", True, 8, args.b
    )
    angle_val_loader = get_dataloader(
        root_dir + "/DATASETS/CLS/TextCls/v0/val/", True, 8, args.b
    )
