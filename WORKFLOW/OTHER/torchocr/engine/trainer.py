...
from WORKFLOW.OTHER.torchocr.utility import update_rec_head_out_channels
from WORKFLOW.OTHER.torchocr.data import build_dataloader
from WORKFLOW.OTHER.torchocr.losses import build_loss
from WORKFLOW.OTHER.torchocr.metrics import build_metric
from WORKFLOW.OTHER.torchocr.modeling.architectures import build_model
from WORKFLOW.OTHER.torchocr.optimizer import build_optimizer
from WORKFLOW.OTHER.torchocr.postprocess import build_post_process
from WORKFLOW.OTHER.torchocr.utils.ckpt import save_ckpt, load_ckpt
from WORKFLOW.OTHER.torchocr.utils.logging import get_logger
from WORKFLOW.OTHER.torchocr.utils.stats import TrainingStats
from WORKFLOW.OTHER.torchocr.utils.utility import AverageMeter
...
class Trainer(object):
    def __init__(self, cfg, mode="train"):
        ...
        if (
            self.local_rank == 0
            and self.cfg["Global"]["use_tensorboard"]
            and "train" in mode
        ):
        ...
        if "train" in mode:
            cfg.save(
                os.path.join(self.cfg["Global"]["output_dir"], "config.yml"), self.cfg
            )
        ...
        self.scaler = (
            ...
            if self.cfg["Global"].get("use_amp", False)
            else None
        )
        ...
        for epoch in range(start_epoch, epoch_num + 1):
            ...
            for idx, batch in enumerate(self.train_dataloader):
                ...
                if self.local_rank == 0 and (
                    ...
                    eta_sec = (
                        (epoch_num + 1 - epoch) * len(self.train_dataloader) - idx - 1
                    ) * eta_meter.avg
            ...
            if (
                ...
                if (
                    cur_metric[self.eval_class.main_indicator]
