...
from WORKFLOW.OTHER.surya.surya.postprocessing.heatmap import get_and_clean_boxes
from WORKFLOW.OTHER.surya.surya.postprocessing.affinity import get_vertical_lines
from WORKFLOW.OTHER.surya.surya.input.processing import (
    prepare_image_detection,
    split_image,
    get_total_splits,
    convert_if_not_rgb,
)
from WORKFLOW.OTHER.surya.surya.schema import TextDetectionResult
...
def batch_detection(
    images: List, model: SegformerForRegressionMask, processor, batch_size=None
...
def batch_text_detection(
    ...
    # print("det 后处理耗时: ", time.time() - starttime)
    return results
