...
class ShuffleNetV2(nn.Module):
    def __init__(self, ratio=0.5, class_num=2):
        super().__init__()
        if ratio == 0.5:
        ...
        self.stage2 = self._make_stage(24, out_channels[0], 1)
        self.stage3 = self._make_stage(out_channels[0], out_channels[1], 1)
        self.stage4 = self._make_stage(out_channels[1], out_channels[2], 1)
