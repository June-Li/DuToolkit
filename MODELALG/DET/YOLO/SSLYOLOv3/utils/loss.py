...
from MODELALG.DET.YOLO.SSLYOLOv3.utils.general import bbox_iou
from MODELALG.DET.YOLO.SSLYOLOv3.utils.torch_utils import is_parallel
...
def compute_loss(p, targets, model):  # predictions, targets, model
    ...
    lbox *= h["box"] * s
    lobj *= h["obj"] * s * (1.4 if no == 4 else 1.0)
    lcls *= h["cls"] * s
