...
import MODELALG.DET.YOLO.YOLOv3.models
from MODELALG.DET.YOLO.SSLYOLOv3.models.experimental import attempt_load
from MODELALG.DET.YOLO.SSLYOLOv3.utils.activations import Hardswish
from MODELALG.DET.YOLO.SSLYOLOv3.utils.general import set_logging, check_img_size

if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument(
        "--weights", type=str, default="./yolov3.pt", help="weights path"
    )  # from yolov3/models/
    parser.add_argument(
