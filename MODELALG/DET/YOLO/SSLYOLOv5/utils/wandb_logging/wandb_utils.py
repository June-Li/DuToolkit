...
from MODELALG.DET.YOLO.SSLYOLOv5.utils.datasets import LoadImagesAndLabels
from MODELALG.DET.YOLO.SSLYOLOv5.utils.datasets import img2label_paths
...
class WandbLogger:
    def __init__(self, opt, name, run_id, data_dict, job_type="Training"):
        ...
        if self.wandb_run:
            ...
            print(
                f"{prefix}Install Weights & Biases for SSLYOLOv5 logging with 'pip install wandb' (recommended)"
            )
    ...
    def check_and_upload_dataset(self, opt):
        ...
        config_path = self.log_dataset_artifact(
            check_file(opt.data),
            opt.single_cls,
            "SSLYOLOv5" if opt.project == "runs/train" else Path(opt.project).stem,
        )
