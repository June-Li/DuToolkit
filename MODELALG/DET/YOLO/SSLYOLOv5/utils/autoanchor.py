...
from MODELALG.DET.YOLO.SSLYOLOv5.utils.general import colorstr


def check_anchor_order(m):
    # Check anchor order against stride order for SSLYOLOv5 Detect() module m, and correct if necessary
