# SSLYOLOv5 YOLO-specific modules
...
from MODELALG.DET.YOLO.SSLYOLOv5.models.common import *
from MODELALG.DET.YOLO.SSLYOLOv5.models.experimental import *
from MODELALG.DET.YOLO.SSLYOLOv5.utils.autoanchor import check_anchor_order
    ...
    def forward(self, x):
        ...
        for i in range(self.nl):
            ...
            if not self.training:  # inference
                ...
                else:  # for SSLYOLOv5 on AWS Inferentia https://github.com/ultralytics/yolov5/pull/2953
